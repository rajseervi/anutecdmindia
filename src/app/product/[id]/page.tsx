      ...
      try {
        ...
        if (productResponse.ok) {
          ...
          if (fetchedProduct?.name) {
            document.title = `${fetchedProduct.name} | Anutec Taps`;
          }
          ...
          if (metaDesc && fetchedProduct?.description) {
            metaDesc.setAttribute(
              "content",
              `${fetchedProduct.name} - ${fetchedProduct.description?.slice(0, 160)}. Available at Anutec Taps.`
            );
          }
          ...
          <div className="flex flex-col">
            ...
            <div className="mt-auto pt-6 space-y-3">
              <a
                ...
                aria-label={`Call Anutec Taps about ${product.name}`}
              >
                <svg className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
